...
RUN apt-get update && apt-get install -y \
    curl ca-certificates python3 python3-pip wget gnupg \
...
RUN curl -L https://github.com/RightNow-AI/openfang/releases/download/v0.3.34/openfang-x86_64-unknown-linux-gnu.tar.gz \
    -o openfang.tar.gz \
